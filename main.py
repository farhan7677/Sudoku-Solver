...
# Function to fill the board with valid numbers using backtracking
...
def generate_partial_sudoku():
    board = [[0 for _ in range(9)] for _ in range(9)]
    # Randomly fill a few cells to kickstart the generation process
    attempts = 5  # Number of random initial numbers
    while attempts > 0:
...
# Function to remove numbers from a full board to create a puzzle
